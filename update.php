...
<section>
        ...
        <form  method="post">
            ...
            <div class="mb-3">
              <textarea name="text-notes"  value = "<?php echo $si?>" id="notes" class="text-note form-control" placeholder="Note"></textarea>
            </div>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $conn->prepare("UPDATE `note` SET ` TITLLE` = ?, `TASK` = ?");
        $result = $stmt->bind_param("ss", $s_titlle, $s_task);
